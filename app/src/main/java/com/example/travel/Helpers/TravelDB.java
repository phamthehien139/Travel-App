...
public class TravelDB extends SQLiteOpenHelper {
    ...
    public void insertIntoTheDatabase(String item_title, int item_image, String id, String fav_status, String country_desc, String currency_des, String language_des, String capital_des, String other_des) {
        SQLiteDatabase db;
        ...
        cv.put(CURRENCY, currency_des);
        cv.put(LANGUAGE, language_des);
    ...
    // chọn tất cả danh sách yêu thích
